            ...
            <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-gradient-to-br from-lime-50 via-white to-sky-50 dark:bg-white/[0.02] dark:bg-none border-r border-slate-200 dark:border-white/[0.05] p-10">
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold leading-tight text-slate-950 dark:text-white">The complete platform for modern merchants.</h2>
                        <p className="text-slate-600 dark:text-zinc-500 text-sm leading-relaxed">Source products, build your store, run ads, and grow — all in one place.</p>
                    </div>
                        ...
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3">
                                <div className="w-5 h-5 rounded-full bg-sky-500/15 border border-sky-500/25 flex items-center justify-center shrink-0">
                                    <svg className="w-2.5 h-2.5 text-sky-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                                </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative">
                ...
                <div className="w-full max-w-[400px]">
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-slate-500 dark:text-zinc-500 mt-1.5">Sign in to your merchant account to continue.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/forgot-password" className="text-[11px] text-sky-600 dark:text-blue-500 hover:text-sky-700 dark:hover:text-blue-400 transition-colors">Forgot password?</Link>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-6 flex items-center gap-3">
                        ...
                        <span className="text-[11px] text-slate-400 dark:text-zinc-600">or</span>
                        <div className="flex-1 h-px bg-slate-200 dark:bg-white/[0.06]" />
                    </div>

                    <p className="mt-6 text-sm text-slate-500 dark:text-zinc-500 text-center">
                        Don&apos;t have an account?{" "}
                        <Link href="/register" className="text-slate-950 dark:text-white hover:text-sky-600 dark:hover:text-blue-400 transition-colors font-medium">Create one free</Link>
                    </p>

                    <div className="mt-8 flex items-center gap-2 justify-center">
                        <ShieldCheck className="w-3.5 h-3.5 text-slate-400 dark:text-zinc-700" />
                        <p className="text-[11px] text-slate-400 dark:text-zinc-700">Encrypted · Secure · OWASP compliant</p>
                    </div>
                </div>
            </div>
        </div>
